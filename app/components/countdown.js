...
const FlipDigit = ({ digit, key, position, total }) => {
  return (
  ...
  return (
    <div className="relative">
      ...
      <motion.div
        ...
        className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 justify-items-center p-8 rounded-xl backdrop-blur-md bg-black/20"
      >
